...
\pagebreak
   ...
   \end{itemize}
	...
	\texbf{Description:} Allows the administrator or HOD to update an existing Research Group\\
	\texbf{Prioritisation:} Important\\
	...
	\texbf{Description:} Allows the administrator or HOD to remove an existing Research Group\\
	\texbf{Prioritisation:} Important\\
	...
	\texbf{Description:} Allows the user to create a new Author\\
	\texbf{Prioritisation:} Critical\\
	...
	\texbf{Description:} Allows the user to update an existing Author\\
	\texbf{Prioritisation:} Important\\
